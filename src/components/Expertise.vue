...
<template>
    <Section id="expertise" size="lg" spacing="normal">
        <div class="max-w-4xl">
            <p class="mb-4 text-sm font-semibold uppercase tracking-[0.3em]" :style="{ color: 'var(--color-primary)' }">
                Core Expertise
            </p>

            <h2 class="text-4xl font-bold leading-tight md:text-5xl lg:text-6xl"
